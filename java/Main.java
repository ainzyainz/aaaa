    ...
    public static void main(String[] args) {
        try (Connection connection = DriverManager.getConnection(JDBCResource.getURL(), JDBCResource.getUser(), JDBCResource.getPassword())) {
          ...
          // addingCustom(connection);
            ...
            PeopleImpl person1 = new PeopleImpl();
            PersonDTO testPerson = PersonDTO.builder()
                    .age(0)
                    .salary(0)
                    .passport(null)
                    .address(null)
                    ...
                    .letter(null)
                    .build();
        //   person1.save(connection, testPerson);
            PersonDTO testPerson1 = PersonDTO.builder()
                    .age(1)
                    .salary(1)
                    .passport(null)
                    .address(null)
                    ...
                    .letter(null)
                    .build();
         //   person1.update(testPerson1,connection,54);

         //   person1.delete(connection,54);

            PersonDTO testPerson2 = person1.findById(58,connection);
